...
function wp_lab_fe_enqueues()
{
  ...
  wp_enqueue_script('CountrySelectJS',plugins_url('js/countrySelect.min.js',__FILE__),array('jquery-3.5.1-js', 'jquery-ui'),"3.6",false);
  wp_enqueue_script('lab-fe', plugins_url('js/lab_fe.js',__FILE__), array('jquery-3.5.1-js', 'jquery-ui-1.12.1-js','CountrySelectJS', 'wp-i18n'), version_id(), false);
