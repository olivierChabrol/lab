...
<div id="em-form-with-recurrence" class="event-form-with-recurrence event-form-when">
	...
	<p>
		...
		<input id="start-time" class="em-time-input em-time-start" type="text" size="8" maxlength="8" name="event_start_time" value="<?php if(isset($_GET['starttime']) && preg_match('/\d{2}:\d{2}/',$_GET['starttime'])){ echo $_GET['starttime'];} else { echo $EM_Event->start()->i18n($hours_format); } ?>" />
		<?php _e('to','events-manager'); ?>
		<input id="end-time" class="em-time-input em-time-end" type="text" size="8" maxlength="8" name="event_end_time" value="<?php if(isset($_GET['endtime']) && preg_match('/\d{2}:\d{2}/',$_GET['endtime'])){ echo $_GET['endtime'];} else { echo $EM_Event->end()->i18n($hours_format); } ?>" />
