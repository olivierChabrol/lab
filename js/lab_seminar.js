jQuery(function($){
    ...
    $("#lab_admin_seminar_create").click(function() {
        if ($("#lab_admin_seminar_name").val() != "")
        {
            let data = {
                ...
                'seminar_location':$("#lab_admin_seminar_location").val(),
                'start':$("#lab_admin_seminar_start").val(),
                'end':$("#lab_admin_seminar_end").val(),
                'funder_int':$("#lab_admin_funder_int").val(),
                'funder_nat':$("#lab_admin_funder_nat").val(),
                'funder_reg':$("#lab_admin_funder_reg").val(),
                'guests_number':$("lab_admin_seminar_guest_number").val(),
                'details':$("lab_admin_seminar_details").val()
            };
            console.log(data);
    ...
    function clearNewFields() {
        ...
        $("#lab_admin_funder_int").val("");
        $("#lab_admin_funder_nat").val("");
        $("#lab_admin_funder_reg").val("");
