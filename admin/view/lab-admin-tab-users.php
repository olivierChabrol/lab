...
<div style="display:flex; flex-wrap:wrap;">
  <form name="lab_admin_user_form">
    <table class="form-table" role="presentation">
      ...
      <tr>
        <th scope="row">
          <label for="lab_user_name">Generate Password</label>
        </th>
        <td>
          <a id="lab_user_passwd_reset_link" href="#"><span id="lab_user_login"></span></a><br/>
          <span id="lab_user_passwd_reset_link_url"></span>
          <a id="lab_btn-copier" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-copy" viewBox="0 0 16 16">
