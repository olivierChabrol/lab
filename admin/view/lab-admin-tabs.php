...
?>
  <div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
      ...
      <a id="laib_users_settings_tab_pointer" style="position: relative" class="nav-tab <?php echo $active_tab == 'params' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg(array('tab' => 'params'), $_SERVER['REQUEST_URI']); ?>"><?php esc_html_e('Settings','lab'); ?></a>
      <a id="laib_users_settings_tab_pointer" style="position: relative" class="nav-tab <?php echo $active_tab == 'ldap' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg(array('tab' => 'ldap'), $_SERVER['REQUEST_URI']); ?>"><?php esc_html_e('LDAP','lab'); ?></a>
      <a id="laib_users_settings_tab_pointer" style="position: relative" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>" href="<?php echo add_query_arg(array('tab' => 'settings'), $_SERVER['REQUEST_URI']); ?>"><?php esc_html_e('Global settings','lab'); ?></a>
    </h2>
